      ...
      <section style={styles.section}>
        ...
        <div style={styles.textBlock}>
          ...
          <div style={styles.warningBox}>
            <p style={{margin: 0}}>
              ⚠️ <strong>Важно:</strong> Несмотря на все меры безопасности, ни один метод передачи 
              данных через интернет не является на 100% безопасным. Вы используете сервис на свой риск.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.textBlock}>
          <p style={styles.paragraph}>
            ...
            О существенных изменениях мы уведомим вас по email.
          </p>
          <p style={styles.paragraph}>
