    ...
    <div style={styles.container}>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.textBlock}>
          ...
          <ul style={styles.list}>
            <li>Возврат возможен в течение 7 дней с момента оплаты</li>
            <li>Условие возврата: токены НЕ должны быть использованы</li>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.textBlock}>
          ...
          <ul style={styles.list}>
            <li>При нарушении условий Соглашения (без возврата средств)</li>
