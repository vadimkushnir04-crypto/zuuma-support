...
<body>
    <div class="container">
        ...
        <!-- ✅ ДОБАВИТЬ предупреждение о CORS -->
        <div class="warning">
            <strong>⚠️ Важно:</strong> Для корректной работы откройте этот файл через локальный сервер:
            <div class="code-block">
                ...
                Затем откройте: http://localhost:8000/test-widget-...html
            </div>
        </div>
