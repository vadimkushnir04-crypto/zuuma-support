    ...
    <div style={styles.container}>
      ...
      <div style={styles.criticalWarning}>
        ...
        <p style={{margin: 0, lineHeight: '1.6'}}>
          Используя платформу Zuuma, вы принимаете все риски, связанные с использованием AI-технологий 
          и пользовательских API-функций. Платформа предоставляется "как есть" (AS IS) без каких-либо гарантий.
        </p>
      </div>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.textBlock}>
          ...
          <p style={styles.paragraph}>
            <strong>Пользователь несет ПОЛНУЮ ответственность</strong> за API-функции, которые он создает и использует на платформе.
          </p>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.textBlock}>
          <p style={styles.paragraph}>
            AI-ассистенты генерируют контент на основе алгоритмов Yandex GPT. 
            Платформа НЕ гарантирует точность или применимость информации.
          </p>
        </div>
      </section>
