            ...
            <div style={modalStyles.section}>
              ...
              <div style={modalStyles.warningBox}>
                <p style={modalStyles.warningText}>
                  ⚠️ При входе через Google ваши данные (email, имя) передаются в <strong>США</strong>. 
                  Требуется дополнительное согласие по 152-ФЗ.
                </p>
              </div>
            ...
            <div style={modalStyles.consents}>
              <label style={modalStyles.checkboxLabel}>
                ...
                <span style={modalStyles.checkboxText}>
                  ...
                  {' '}и даю согласие на обработку ПД (152-ФЗ)
                </span>
              </label>
              ...
              <label style={modalStyles.checkboxLabel}>
                ...
                />
                <span style={modalStyles.checkboxText}>
                  Согласие на передачу данных в США (только для Google OAuth)
                </span>
              </label>
            </div>
